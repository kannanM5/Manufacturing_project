...
function ForgotPasspage() {
  ...
  const {
    ...
    initialValues: {
      ...
      organization_code: "",
      email_ph_no: "",
      resetKeyrepass: location?.state?.resetKeyrestpass || "",
    },

    // validationSchema: validationSchema,
    onSubmit: (values) => {
      handleForgotpassord(values);
    },
  });
  ...
  /**
   * Handles the forgot password functionality by sending a request to the server with the provided data.
   * @param {forgotPasswordProps} data - The data object containing the necessary information for the forgot password request.
   * @returns None
   */
  // const handleForgotpassord = (data) => {
  //   setloader(true);
  ...
  //             org_code: values?.organization_code,
